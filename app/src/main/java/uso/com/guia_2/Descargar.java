...
public class Descargar extends AsyncTask<String, Integer, Estado> {
    ...
    public Descargar(Context context,TextView estado,Button descargar,ProgressBar porcentaje, String NombreArchivo) {
        this.context      = context;
        this.lblEstado    = estado;
        this.btnDescargar = descargar;
        this.prbPorcentaje = porcentaje;
    ...
    protected void onPreExecute() {//esto ocurre antes de descargar
        ...
        //Inicializacion de variables del ProgressBar
        prbPorcentaje.setMax(100);
        prbPorcentaje.setProgress(0);
    }
    ...
    protected void onProgressUpdate(Integer... progress) {//esto ocurre mientras se descarga
        ...
        prbPorcentaje.setProgress(progress[0]);
    }
